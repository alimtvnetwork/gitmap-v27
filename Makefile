...
LDFLAGS  := -s -w \
  -X 'github.com/alimtvnetwork/gitmap-v26/gitmap/constants.Version=$(VERSION)' \
  -X 'github.com/alimtvnetwork/gitmap-v26/gitmap/cmd.BuildCommit=$(BUILD_COMMIT)' \
  -X 'github.com/alimtvnetwork/gitmap-v26/gitmap/cmd.BuildBranch=$(BUILD_BRANCH)' \
  -X 'github.com/alimtvnetwork/gitmap-v26/gitmap/cmd.BuildRepo=$(BUILD_REPO)' \
  -X 'github.com/alimtvnetwork/gitmap-v26/gitmap/cmd.BuildDate=$(BUILD_DATE)'
