...
```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.53.0/release-version-v6.53.0.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.53.0/release-version-v6.53.0.sh | bash
```

#### 🧭 Version matrix — `v6.53.0` install-script URLs

One-line installers and release assets for the pinned **v6.53.0** build across every supported platform. All URLs resolve to the exact release tag — no fallback, no discovery.

| Platform | Shell | Install-script URL | Release binary asset |
| --- | --- | --- | --- |
| **Windows** (amd64) | PowerShell | [`release-version-v6.53.0.ps1`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.53.0/release-version-v6.53.0.ps1) | [`gitmap-v6.53.0-windows-amd64.zip`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.53.0/gitmap-v6.53.0-windows-amd64.zip) |
| **macOS** (arm64) | Bash | [`release-version-v6.53.0.sh`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.53.0/release-version-v6.53.0.sh) | [`gitmap-v6.53.0-darwin-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.53.0/gitmap-v6.53.0-darwin-arm64.tar.gz) |
| **macOS** (amd64) | Bash | [`release-version-v6.53.0.sh`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.53.0/release-version-v6.53.0.sh) | [`gitmap-v6.53.0-darwin-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.53.0/gitmap-v6.53.0-darwin-amd64.tar.gz) |
| **Linux** (amd64) | Bash | [`release-version-v6.53.0.sh`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.53.0/release-version-v6.53.0.sh) | [`gitmap-v6.53.0-linux-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.53.0/gitmap-v6.53.0-linux-amd64.tar.gz) |
| **Linux** (arm64) | Bash | [`release-version-v6.53.0.sh`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.53.0/release-version-v6.53.0.sh) | [`gitmap-v6.53.0-linux-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.53.0/gitmap-v6.53.0-linux-arm64.tar.gz) |

> **Release page:** [github.com/alimtvnetwork/gitmap-v26/releases/tag/v6.53.0](https://github.com/alimtvnetwork/gitmap-v26/releases/tag/v6.53.0) · **Asset naming contract:** `gitmap-<version>-<os>-<arch>.<ext>` (`.zip` on Windows, `.tar.gz` elsewhere) — verified by the installer pre-flight HEAD probe.
