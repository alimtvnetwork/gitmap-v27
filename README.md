...
```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.28.0/release-version-v6.28.0.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.28.0/release-version-v6.28.0.sh | bash
```
...
| --- | --- | --- | --- |
| **Windows** (amd64) | PowerShell | [`release-version-v6.28.0.ps1`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.28.0/release-version-v6.28.0.ps1) | [`gitmap-v26.28.0-windows-amd64.zip`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.28.0/gitmap-v26.28.0-windows-amd64.zip) |
| **macOS** (arm64) | Bash | [`release-version-v6.28.0.sh`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.28.0/release-version-v6.28.0.sh) | [`gitmap-v26.28.0-darwin-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.28.0/gitmap-v26.28.0-darwin-arm64.tar.gz) |
| **macOS** (amd64) | Bash | [`release-version-v6.28.0.sh`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.28.0/release-version-v6.28.0.sh) | [`gitmap-v26.28.0-darwin-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.28.0/gitmap-v26.28.0-darwin-amd64.tar.gz) |
| **Linux** (amd64) | Bash | [`release-version-v6.28.0.sh`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.28.0/release-version-v6.28.0.sh) | [`gitmap-v26.28.0-linux-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.28.0/gitmap-v26.28.0-linux-amd64.tar.gz) |
| **Linux** (arm64) | Bash | [`release-version-v6.28.0.sh`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.28.0/release-version-v6.28.0.sh) | [`gitmap-v26.28.0-linux-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v26/releases/download/v6.28.0/gitmap-v26.28.0-linux-arm64.tar.gz) |

> **Release page:** [github.com/alimtvnetwork/gitmap-v26/releases/tag/v6.28.0](https://github.com/alimtvnetwork/gitmap-v26/releases/tag/v6.28.0) · **Asset naming contract:** `gitmap-<version>-<os>-<arch>.<ext>` (`.zip` on Windows, `.tar.gz` elsewhere) — verified by the installer pre-flight HEAD probe.
