...
### 📌 Pinned version (`v5.36.0`)

```powershell
# Windows · PowerShell
irm https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.36.0/release-version-v5.36.0.ps1 | iex
```

```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.36.0/release-version-v5.36.0.sh | bash
```

#### 🧭 Version matrix — `v5.36.0` install-script URLs

One-line installers and release assets for the pinned **v5.36.0** build across every supported platform. All URLs resolve to the exact release tag — no fallback, no discovery.

| Platform | Shell | Install-script URL | Release binary asset |
| --- | --- | --- | --- |
| **Windows** (amd64) | PowerShell | [`release-version-v5.36.0.ps1`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.36.0/release-version-v5.36.0.ps1) | [`gitmap-v20.45.0-windows-amd64.zip`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.36.0/gitmap-v20.45.0-windows-amd64.zip) |
| **macOS** (arm64) | Bash | [`release-version-v5.36.0.sh`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.36.0/release-version-v5.36.0.sh) | [`gitmap-v20.45.0-darwin-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.36.0/gitmap-v20.45.0-darwin-arm64.tar.gz) |
| **macOS** (amd64) | Bash | [`release-version-v5.36.0.sh`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.36.0/release-version-v5.36.0.sh) | [`gitmap-v20.45.0-darwin-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.36.0/gitmap-v20.45.0-darwin-amd64.tar.gz) |
| **Linux** (amd64) | Bash | [`release-version-v5.36.0.sh`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.36.0/release-version-v5.36.0.sh) | [`gitmap-v20.45.0-linux-amd64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.36.0/gitmap-v20.45.0-linux-amd64.tar.gz) |
| **Linux** (arm64) | Bash | [`release-version-v5.36.0.sh`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.36.0/release-version-v5.36.0.sh) | [`gitmap-v20.45.0-linux-arm64.tar.gz`](https://github.com/alimtvnetwork/gitmap-v20/releases/download/v5.36.0/gitmap-v20.45.0-linux-arm64.tar.gz) |

> **Release page:** [github.com/alimtvnetwork/gitmap-v20/releases/tag/v5.36.0](https://github.com/alimtvnetwork/gitmap-v20/releases/tag/v5.36.0) · **Asset naming contract:** `gitmap-<version>-<os>-<arch>.<ext>` (`.zip` on Windows, `.tar.gz` elsewhere) — verified by the installer pre-flight HEAD probe.
...
> Add `-Version v5.36.0` (PowerShell) or `--version v5.36.0` (Bash) before the closing quote / end of line to pin a specific release into your custom directory.
...
gitmap prc gitmap v5.36.0, marco v2.5.0, https://github.com/me/other v3.1.0
