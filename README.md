...
#### 🧭 Version matrix — `v5.69.0` install-script URLs

One-line installers and release assets for the pinned **v5.69.0** build across every supported platform. All URLs resolve to the exact release tag — no fallback, no discovery.
