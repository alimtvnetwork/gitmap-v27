...
func TestPreviewAllTargets_NumberedRulesOnly(t *testing.T) {
	body := "gitmap-v1 and gitmap-v2 and gitmap-v2 and gitmap-v5"
...
func TestPreviewAllTargets_BareBaseSweepAtV2(t *testing.T) {
	body := "gitmap bare and gitmap-v1 numbered"
...
func TestPreviewAllTargets_TotalMatchesRewriteEngine(t *testing.T) {
	...
	body := "gitmap and gitmap-v1 plus gitmap-v2 plus gitmap-v3"
	cases := []struct {
		current int
		targets []int
		restr   bool
