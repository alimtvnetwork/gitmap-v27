...
// adjacent token (`gitmap-v26`) that MUST NOT match `gitmap-v26`.
...
//
// IMPORTANT: this body MUST contain `gitmap-v26` tokens (the rewrite
// target) and a `gitmap-v26` guarded neighbor. A previous global
...
// project's own module suffix (`gitmap`) collapses to `gitmap-v26` /
...
// `gitmap-v26` must survive untouched when bumping target=9, because
