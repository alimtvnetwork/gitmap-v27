...
func TestSlugFromRemote(t *testing.T) {
	cases := map[string]string{
		...
		"git@github.com:alimtvnetwork/gitmap-v26.git":     "gitmap-v26",
		"git@github.com:alimtvnetwork/gitmap-v26":         "gitmap-v26",
		"ssh://git@host.example/foo/bar/gitmap-v26.git":   "gitmap-v26",
		"gitmap-v26":     "gitmap-v26",
		"gitmap-v26.git": "gitmap-v26",
	}
...
// `current` value — historically this test pinned `gitmap-v26` next to
...
// `gitmap-v26` next to a `current=9` argument.
