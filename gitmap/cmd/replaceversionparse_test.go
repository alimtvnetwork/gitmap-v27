...
func TestSlugFromRemote(t *testing.T) {
	cases := map[string]string{
		"https://github.com/alimtvnetwork/gitmap-v19.git": "gitmap-v19",
		"https://github.com/alimtvnetwork/gitmap-v19":     "gitmap-v19",
		"git@github.com:alimtvnetwork/gitmap-v19.git":     "gitmap-v19",
		"git@github.com:alimtvnetwork/gitmap-v19":         "gitmap-v19",
		"ssh://git@host.example/foo/bar/gitmap-v19.git":   "gitmap-v19",
		"gitmap-v19":     "gitmap-v19",
		"gitmap-v19.git": "gitmap-v19",
	}
...
// `current` value — historically this test pinned `gitmap-v19` next to
...
// `gitmap-v19` next to a `current=9` argument.
