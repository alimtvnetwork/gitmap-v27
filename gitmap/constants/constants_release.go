...
const (
	GitmapRepoPrefix     = "github.com/alimtvnetwork/gitmap-v23"
...
`
  ...
  🪟  Windows · PowerShell
     irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v23/main/gitmap/scripts/install.ps1 | iex
`
	...
	MsgInstallHintUnix = `
  🐧  Linux / macOS
     curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v23/main/gitmap/scripts/install.sh | sh
...
const (
	...
	ReleaseSnippetTemplate = "<!-- gitmap-pinned-install-snippet:%s -->\n" +
		...
		"```powershell\n" +
		"$ver = '%s'\n" +
		"$installer = irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v23/main/gitmap/scripts/install.ps1\n" +
		"& ([scriptblock]::Create($installer)) -Version $ver -NoDiscovery\n" +
		"```\n\n" +
		"**Linux / macOS (bash)**\n" +
		"```bash\n" +
		"curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v23/main/gitmap/scripts/install.sh \\\n" +
