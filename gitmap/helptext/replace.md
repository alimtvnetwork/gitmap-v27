...
### Version bump (`-3` on a `gitmap-v19` repo)

```
$ gitmap replace -3

  replace: scanning 412 files in /repo
  replace: go.mod: 1 match (gitmap-v19 -> gitmap-v19)
  replace: docs/upgrade.md: 4 matches (gitmap-v19 -> gitmap-v19)
...
$ gitmap replace --audit
  ...
  README.md:42: see https://github.com/x/gitmap-v19 for the legacy guide
  go.mod:3: module github.com/x/gitmap-v19
```
