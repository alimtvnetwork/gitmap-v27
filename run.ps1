...
function Build-Binary {
    ...
    try {
        ...
        $ldflags = "-X 'github.com/alimtvnetwork/gitmap-v26/gitmap/constants.RepoPath=$absRepoRoot'" +
                   " -X 'github.com/alimtvnetwork/gitmap-v26/gitmap/cmd.BuildCommit=$buildCommit'" +
                   " -X 'github.com/alimtvnetwork/gitmap-v26/gitmap/cmd.BuildBranch=$buildBranch'" +
                   " -X 'github.com/alimtvnetwork/gitmap-v26/gitmap/cmd.BuildRepo=$buildRepo'" +
                   " -X 'github.com/alimtvnetwork/gitmap-v26/gitmap/cmd.BuildDate=$buildDate'"
