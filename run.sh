...
build_binary() {
    ...
    local ldflags="-X 'github.com/alimtvnetwork/gitmap-v26/gitmap/constants.RepoPath=$abs_repo_root'"
    ldflags="$ldflags -X 'github.com/alimtvnetwork/gitmap-v26/gitmap/cmd.BuildCommit=$build_commit'"
    ldflags="$ldflags -X 'github.com/alimtvnetwork/gitmap-v26/gitmap/cmd.BuildBranch=$build_branch'"
    ldflags="$ldflags -X 'github.com/alimtvnetwork/gitmap-v26/gitmap/cmd.BuildRepo=$build_repo'"
    ldflags="$ldflags -X 'github.com/alimtvnetwork/gitmap-v26/gitmap/cmd.BuildDate=$build_date'"
