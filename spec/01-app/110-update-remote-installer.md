...
2. Unless `--source-rebuild` is present, run `runUpdateRemoteInstall()`:
   - Resolve the installer URL for the host OS:
     - **Windows** → `https://raw.githubusercontent.com/alimtvnetwork/gitmap-v23/main/install.ps1`
     - **macOS / Linux** → `https://raw.githubusercontent.com/alimtvnetwork/gitmap-v23/main/install.sh`
