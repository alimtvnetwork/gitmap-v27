...
defined ad-hoc via flags on `gitmap-v23 release`.
...
```
gitmap-v23 zip-group create <name> [--archive <filename.zip>]
gitmap-v23 zip-group add <name> <path> [<path>...]
gitmap-v23 zip-group remove <name> <path>
gitmap-v23 zip-group list
gitmap-v23 zip-group show <name>
gitmap-v23 zip-group delete <name>
gitmap-v23 zip-group rename <name> --archive <filename.zip>
```
...
gitmap-v23 z create docs-bundle
gitmap-v23 z add docs-bundle ./README.md ./CHANGELOG.md ./docs/

# Create with custom archive name
gitmap-v23 z create extras --archive extra-files.zip
gitmap-v23 z add extras ./config/ ./scripts/deploy.sh

# List groups
gitmap-v23 z list

# Show group contents
gitmap-v23 z show docs-bundle

# Delete a group
gitmap-v23 z delete extras
```
...
```bash
gitmap-v23 release v3.0.0 --zip-group docs-bundle
gitmap-v23 release v3.0.0 --zip-group docs-bundle --zip-group extras
```
...
gitmap-v23 release v3.0.0 -Z ./dist/report.pdf -Z ./dist/manual.pdf

# Bundle all ad-hoc items into one archive
gitmap-v23 release v3.0.0 -Z ./dist/report.pdf -Z ./dist/manual.pdf --bundle docs.zip
```
...
```bash
gitmap-v23 release v3.0.0 --zip-group docs-bundle -Z ./extras/notes.txt
```
...
1. `gitmap-v23 z create docs` creates a persistent zip group in the database.
2. `gitmap-v23 z add docs ./README.md ./docs/` adds items to the group.
3. `gitmap-v23 z show docs` displays all items with file/folder indicators.
4. `gitmap-v23 z list` lists all zip groups with item counts.
5. `gitmap-v23 z delete docs` removes the group and all its items.
6. `gitmap-v23 release v1.0.0 --zip-group docs` creates `docs_v1.0.0.zip` and attaches it.
7. `gitmap-v23 release v1.0.0 -Z ./file.txt` creates `file.txt.zip` and attaches it.
8. `gitmap-v23 release v1.0.0 -Z ./a.txt -Z ./b.txt --bundle extras.zip` bundles both into one archive.
