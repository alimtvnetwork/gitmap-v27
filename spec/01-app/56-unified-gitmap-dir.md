...
```go
// Root directory — all repo-local gitmap-v23 data lives here.
...
Projects using gitmap-v23 should add `.gitmap/output/` to their `.gitignore`.
...
When any gitmap-v23 command runs and detects a legacy directory in the current
