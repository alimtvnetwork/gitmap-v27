...
```go
// Root directory — all repo-local gitmap-v26 data lives here.
...
Projects using gitmap-v26 should add `.gitmap/output/` to their `.gitignore`.
...
When any gitmap-v26 command runs and detects a legacy directory in the current
