...
```text
gitmap-v26 clone-next <v++|v+1|vN> [flags]
```
...
```text
D:\wp-work\riseup-asia\macro-ahk-v11> gitmap-v26 cn v++
...
```text
D:\wp-work\riseup-asia\macro-ahk-v12> gitmap-v26 cn v15 --delete
...
```text
D:\wp-work\riseup-asia\macro-ahk> gitmap-v26 cn v++
...
```text
D:\wp-work\riseup-asia\macro-ahk-v12> gitmap-v26 cn v15 --create-remote --delete
...
```text
D:\wp-work\riseup-asia\macro-ahk-v11> gitmap-v26 cn v++ --delete
...
1. `gitmap-v26 cn v++` clones into the base name folder (flattened) by default.
2. `gitmap-v26 cn v+1` behaves exactly like `v++`.
3. `gitmap-v26 cn v15` clones the exact target version into the flattened folder.
