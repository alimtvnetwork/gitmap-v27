...
The `help-dashboard` command (alias `hd`) serves the gitmap-v23 documentation
...
```
gitmap-v23 help-dashboard [flags]
gitmap-v23 hd [flags]
```
...
The command locates the docs site relative to the gitmap-v23 binary:
...
1. `gitmap-v23 help-dashboard` serves `dist/` when it exists and opens
   the browser automatically.
2. `gitmap-v23 hd` works as an alias.
...
7. `gitmap-v23 help-dashboard --help` prints the embedded help text.
