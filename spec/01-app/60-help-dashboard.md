...
The `help-dashboard` command (alias `hd`) serves the gitmap-v26 documentation
...
```
gitmap-v26 help-dashboard [flags]
gitmap-v26 hd [flags]
```
...
The command locates the docs site relative to the gitmap-v26 binary:
...
1. `gitmap-v26 help-dashboard` serves `dist/` when it exists and opens
   the browser automatically.
2. `gitmap-v26 hd` works as an alias.
...
7. `gitmap-v26 help-dashboard --help` prints the embedded help text.
