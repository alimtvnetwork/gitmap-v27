...
Allow `gitmap-v26 clone` to accept a direct Git URL (HTTPS or SSH) instead of
...
```
gitmap-v26 clone <url>                          # clone into repo-name folder
gitmap-v26 clone <url> <folder-name>            # clone into custom folder
gitmap-v26 clone <url> --github-desktop         # auto-register (no prompt)
```
...
```
gitmap-v26 clone https://github.com/alimtvnetwork/wp-alim.git
```
...
```
gitmap-v26 clone https://github.com/alimtvnetwork/wp-alim.git "my-project"
```
...
```
gitmap-v26 clone git@github.com:alimtvnetwork/wp-alim.git
```
