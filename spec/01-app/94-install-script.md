...
One-liner installer scripts that download, verify, and install the `gitmap-v26`
...
| Field       | Value                                              |
|-------------|----------------------------------------------------|
| GitHub Repo | `alimtvnetwork/gitmap-v26`                 |
| Binary Name | `gitmap-v26` (`gitmap.exe` on Windows)                 |
...
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/alimtvnetwork/gitmap-v26/main/gitmap-v26/scripts/install.ps1'))
```
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v26/main/gitmap-v26/scripts/install.ps1 | iex
```
...
| `InstallDir` | string | `$env:LOCALAPPDATA\gitmap-v26`     | Target directory for the binary    |
...
`gitmap-v26/scripts/install.ps1`
...
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v26/main/gitmap-v26/scripts/install.sh | bash -s -- --version v2.55.0
```

### Custom Directory

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v26/main/gitmap-v26/scripts/install.sh | bash -s -- --dir /opt/gitmap-v26 --version v2.55.0
```
...
7. Extract archive to temp directory; search for binary using 4-priority
   ...
   (e.g., `gitmap-v26.55.0-linux-amd64`) → any executable.
