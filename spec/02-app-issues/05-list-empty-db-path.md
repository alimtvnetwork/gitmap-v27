# Issue 05: `gitmap-v26 ls` Returns Empty After Scan

## Symptom

Running `gitmap-v26 ls` shows "No repos tracked. Run 'gitmap-v26 scan' first."
...
After fix: `gitmap-v26 ls --verbose` should print the resolved DB path.
