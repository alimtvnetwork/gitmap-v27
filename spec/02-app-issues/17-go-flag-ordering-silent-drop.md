...
Running `gitmap-v23 release v2.55.0 -y` silently ignored the `-y` flag,
...
3. **Inconsistent UX** — `gitmap-v23 release -y v2.55.0` worked correctly,
   but `gitmap-v23 release v2.55.0 -y` did not, violating the principle
   of least surprise.
