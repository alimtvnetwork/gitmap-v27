...
After installing gitmap-v26 via `curl | sh` on macOS (zsh default), the binary
...
3. gitmap-v26 works in zsh terminals.
4. User opens `sh` or switches to bash → `gitmap-v26: command not found`.
