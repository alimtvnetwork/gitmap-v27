...
cmd/installvscode.go:11:2: "github.com/alimtvnetwork/gitmap-v26/gitmap-v26/constants" imported and not used
```
...
`installvscode.go` imported `github.com/alimtvnetwork/gitmap-v26/gitmap-v26/constants` but never
...
1. Before adding a helper function to a new file, search the `cmd` package
   ...
   `grep -rn "^func <name>" gitmap-v26/cmd/`
