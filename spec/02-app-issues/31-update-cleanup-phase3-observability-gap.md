...
`gitmap-v23 update` can still appear to "repeat the same cleanup error with no logs" even after the Phase 3 deployed-binary handoff was introduced.
...
- `gitmap-v23/cmd/updatecleanup.go`
- `gitmap-v23/cmd/updatecleanup_remove.go`
- `gitmap-v23/cmd/updatecleanup_extra.go`
- `gitmap-v23/cmd/updatehandoff_phase3.go`
- `gitmap-v23/cmd/updatehandofflog.go`
- `gitmap-v23/cmd/updatedebugwindows.go`
- `gitmap-v23/cmd/updatedebugwindows_json.go`
...
- Native Windows manual check with `gitmap-v23 update --debug-windows --debug-windows-json` should now produce both console diagnostics and durable per-branch child failure events.
