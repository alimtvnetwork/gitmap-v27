...
```
  Version before:   gitmap-v23 v2.66.0
  Version active:   gitmap-v23 v2.67.0
  ...
  [TRACE] activeAfter=gitmap-v23 v2.67.0  deployedAfter=unknown
  [HINT] Check that powershell.json 'deployPath' points to the correct directory
         and that the binary exists at: <path>
  [OK] Active PATH binary updated successfully: gitmap-v23 v2.67.0
```
...
| `Get-Command gitmap-v23: not found in PATH` | Active binary not discoverable via PATH |
