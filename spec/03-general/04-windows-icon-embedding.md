  ...
  "RT_MANIFEST": {
    "APP": {
      "0000": {
        ...
        "description": "gitmap-v23 - Git repository scanner, mapper, and manager",
        "minimum-os": "win7",
      ...
      "0000": {
        ...
        "info": {
          "0409": {
            ...
            "FileDescription": "gitmap-v23 CLI",
            "FileVersion": "",
            "InternalName": "gitmap-v23",
            "LegalCopyright": "© 2026 Riseup Asia LLC",
            "OriginalFilename": "gitmap.exe",
            "ProductName": "gitmap-v23",
            "ProductVersion": ""
          }
        }
      }
...
|---------|--------|-------|
| File Explorer | Generic `.exe` icon | Custom gitmap-v23 icon |
| Properties → Details | Empty metadata | Version, company, description |
| Taskbar | Generic icon | Branded icon |
| Task Manager | `gitmap.exe` | `gitmap-v23` with description |
