...
1. Create a **Project** named `gitmap-v26`
...
| `SIGNPATH_PROJECT_SLUG` | Project settings | e.g., `gitmap-v26` |
...
```yaml
# Sign both gitmap-v26 and gitmap-updater Windows builds
WINDOWS_BINARIES=(
...
- **Sign all Windows binaries** — gitmap-v26 + gitmap-updater
