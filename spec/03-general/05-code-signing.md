...
1. Create a **Project** named `gitmap-v23`
...
| `SIGNPATH_PROJECT_SLUG` | Project settings | e.g., `gitmap-v23` |
...
```yaml
# Sign both gitmap-v23 and gitmap-updater Windows builds
WINDOWS_BINARIES=(
...
- **Sign all Windows binaries** — gitmap-v23 + gitmap-updater
