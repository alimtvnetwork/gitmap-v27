...
> - App reference: [spec/01-app/31-cd.md](../01-app/31-cd.md) — gitmap-v23 navigation helper that consumes this contract
...
These bugs in the gitmap-v23 project triggered this generic spec:
