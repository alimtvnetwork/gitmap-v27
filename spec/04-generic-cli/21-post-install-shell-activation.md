...
> - App reference: [spec/01-app/31-cd.md](../01-app/31-cd.md) — gitmap-v26 navigation helper that consumes this contract
...
These bugs in the gitmap-v26 project triggered this generic spec:
