...
```
User runs: gitmap-v26 scan --verbose
  │
...
✓ Deploy path       OK — E:\bin-run\gitmap-v26\
```
...
|----------|--------|---------|
| User (stderr) | Plain, actionable | `"Error: config.json not found. Run 'gitmap-v26 doctor' to diagnose."` |
