...
```
User runs: gitmap-v23 scan --verbose
  │
...
✓ Deploy path       OK — E:\bin-run\gitmap-v23\
```
...
|----------|--------|---------|
| User (stderr) | Plain, actionable | `"Error: config.json not found. Run 'gitmap-v23 doctor' to diagnose."` |
