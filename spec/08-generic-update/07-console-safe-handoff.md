...
`gitmap-v23` solves this in two blocking layers:

### Layer 1 — Parent → Handoff Worker

In `gitmap-v23/cmd/update.go`:
...
In `gitmap-v23/cmd/updatescript.go`:
...
- [../02-app-issues/03-update-sync-lock-loop.md](../02-app-issues/03-update-sync-lock-loop.md) — The real gitmap-v23 failure and its resolution
