...
(`.github/workflows/release.yml`, line 54), which reads `gitmap-v26/winres/winres.json`
...
2. Updated `gitmap-v26/winres/winres.json` to reference `icon-256.png` instead.
...
| `gitmap-v26/assets/icon.png` | 512x512 original icon (web/docs use) |
