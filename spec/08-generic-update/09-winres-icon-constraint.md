...
(`.github/workflows/release.yml`, line 54), which reads `gitmap-v23/winres/winres.json`
...
2. Updated `gitmap-v23/winres/winres.json` to reference `icon-256.png` instead.
...
| `gitmap-v23/assets/icon.png` | 512x512 original icon (web/docs use) |
