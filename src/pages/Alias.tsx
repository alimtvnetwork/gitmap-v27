...
Alias:    a
Usage:    gitmap-v23 alias <subcommand> [args]
...
Prerequisites:
  • Run 'gitmap-v23 scan' first to populate the database

Examples:
  gitmap-v23 alias set api github/user/api-gateway
  gitmap-v23 a list
  gitmap-v23 alias suggest
  gitmap-v23 pull -A api
  gitmap-v23 cd -A web
...
const listDemo = [
  { text: "gitmap-v23 alias list", type: "input" as const, delay: 800 },
...
const suggestDemo = [
  { text: "gitmap-v23 alias suggest", type: "input" as const, delay: 800 },
  { text: "", type: "output" as const },
...
const usageDemo = [
  { text: "gitmap-v23 pull -A api", type: "input" as const, delay: 800 },
  { text: "", type: "output" as const },
  ...
  { text: "", type: "output" as const },
  { text: "gitmap-v23 cd -A web", type: "input" as const, delay: 800 },
...
const features = [
  ...
  { icon: Zap, title: "Run From Anywhere", desc: "Execute any gitmap-v23 command against a repo using -A <alias> without changing directory." },
  { icon: Search, title: "Auto-Suggest", desc: "During scan/rescan, aliases are suggested based on repo name or slug." },
  { icon: Shield, title: "Conflict-Safe", desc: "Warns and prompts when an alias collision occurs. Cannot shadow gitmap-v23 commands." },
];
...
const AliasPage = () => (
  <DocsLayout>
    ...
    <CodeBlock code={helpText} language="bash" title="gitmap-v23 alias --help" />
    ...
    <TerminalDemo title="gitmap-v23 alias list" lines={listDemo} autoPlay />
    ...
    <TerminalDemo title="gitmap-v23 alias suggest" lines={suggestDemo} />
    ...
    <TerminalDemo title="gitmap-v23 — alias in action" lines={usageDemo} />
    ...
    <CodeBlock code="gitmap-v23 alias set api github/user/api-gateway" title="Create an alias" />
    <CodeBlock code="gitmap-v23 a set web github/user/web-frontend" title="Using short alias 'a'" />
    <CodeBlock code="gitmap-v23 alias list" title="List all aliases" />
    <CodeBlock code="gitmap-v23 alias show api" title="Show alias details" />
    <CodeBlock code="gitmap-v23 alias remove api" title="Remove an alias" />
    <CodeBlock code="gitmap-v23 alias suggest" title="Auto-suggest aliases" />
    <CodeBlock code="gitmap-v23 alias suggest --apply" title="Auto-accept all suggestions" />

    <h2 className="text-xl font-heading font-semibold mt-10 mb-3 docs-h2">Global -A Flag Examples</h2>
    <CodeBlock code="gitmap-v23 pull -A api" title="Pull via alias" />
    <CodeBlock code="gitmap-v23 exec -A web -- npm test" title="Run command in aliased repo" />
    <CodeBlock code="gitmap-v23 cd -A infra" title="Navigate to aliased repo" />
    <CodeBlock code="gitmap-v23 status -A api" title="Check status via alias" />
    ...
    <div className="grid md:grid-cols-2 gap-4 mb-8">
      ...
      <div className="rounded-lg border border-border bg-card p-4">
        ...
        <p className="text-xs text-muted-foreground">
          Alias names cannot match gitmap-v23 command names (e.g., <code className="docs-inline-code">scan</code>, <code className="docs-inline-code">pull</code>).
        </p>
      </div>
      <div className="rounded-lg border border-border bg-card p-4">
