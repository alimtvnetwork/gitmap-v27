...
const ACTIONS = [
  ...
  },
  {
    key: "g",
    name: "Add to Group",
    description: "Add the currently selected repositories to an existing group or create a new one. Groups persist in the database and can be used for scoped operations across all gitmap-v26 commands.",
    examples: [
    ...
    <DocsLayout>
      <div className="max-w-4xl">
        ...
        <section className="mb-10 ">
          <TerminalDemo
            title="gitmap-v26 interactive — batch pull"
            lines={[
              { text: "gitmap-v26 interactive", type: "input" as const, delay: 800 },
              { text: "", delay: 200 },
              { text: "gitmap-v26 TUI v2.17.0", type: "header" as const, delay: 150 },
              { text: "", delay: 100 },
        ...
        <section className="mb-10 ">
          <TerminalDemo
            title="gitmap-v26 interactive — batch exec"
            lines={[
        ...
        <section className="mb-10 ">
          <TerminalDemo
            title="gitmap-v26 interactive — batch status"
            lines={[
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-b border-border">
                  ...
                  <td className="px-4 py-2 font-mono text-primary">gitmap-v26 pull --group &lt;name&gt;</td>
                ...
                <tr className="border-b border-border">
                  ...
                  <td className="px-4 py-2 font-mono text-primary">gitmap-v26 exec --group &lt;name&gt; &lt;cmd&gt;</td>
                ...
                <tr className="border-b border-border">
                  ...
                  <td className="px-4 py-2 font-mono text-primary">gitmap-v26 status --group &lt;name&gt;</td>
                ...
                <tr className="border-b border-border last:border-0">
                  ...
                  <td className="px-4 py-2 font-mono text-primary">gitmap-v26 group add &lt;name&gt; &lt;slugs&gt;</td>
        ...
        <section className="mb-10">
          ...
          <TerminalDemo
            title="gitmap-v26 pull — progress tracking"
            lines={[
              { text: "gitmap-v26 pull --group backend", type: "input" as const, delay: 800 },
              { text: "", delay: 200 },
