...
const ChangelogGenerate = () => {
    ...
    <DocsLayout>
      <div className="max-w-4xl">
        ...
        <section className="mb-10">
          ...
          <CodeBlock
            code={`gitmap-v23 changelog-generate [--from <tag>] [--to <tag>] [--write]\ngitmap cg [--from <tag>] [--to <tag>] [--write]`}
            language="bash"
            title="Command"
          />
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            <div>
              ...
              <CodeBlock
                code={`$ gitmap-v23 changelog-generate
  ...
  - Fix watch interval validation edge case`}
            ...
            <div>
              ...
              <CodeBlock
                code={`$ gitmap-v23 cg --from v2.22.0
  ...
  - Fix zip-group archive naming`}
            ...
            <div>
              ...
              <CodeBlock
                code={`$ gitmap-v23 cg --from v2.23.0 --to v2.24.0 --write
