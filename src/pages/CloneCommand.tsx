...
const CloneCommandPage = () => {
  return (
    <DocsLayout>
      <h1 className="text-3xl font-heading font-bold mb-2 docs-h1">gitmap-v23 clone</h1>
      ...
      <section className="space-y-8">
        <div>
          ...
          <CodeBlock code={`gitmap-v23 clone <source|json|csv|text|url> [folder] [flags]`} title="Syntax" />
        ...
        <div>
          ...
          <CodeBlock code={`gitmap-v23 clone https://github.com/alimtvnetwork/wp-onboarding-v13.git`} title="Terminal" />
          <CodeBlock
            language="bash"
            title="Output"
...
Cloned wp-onboarding-v13 successfully.
  ...
  VS Code opened.`}
          ...
          <CodeBlock code={`gitmap-v23 clone https://github.com/alimtvnetwork/wp-alim.git "my-project"`} title="Terminal" />

          <h3 className="text-base font-heading font-semibold mb-2 mt-6 docs-h3">Clone from JSON scan output</h3>
          <CodeBlock code={`gitmap-v23 clone json --target-dir D:\\projects`} title="Terminal" />
          <CodeBlock
            language="bash"
            title="Output"
...
Clone complete: 12 succeeded, 0 failed`}
          ...
          <CodeBlock code={`gitmap-v23 c csv --safe-pull`} title="Terminal" />
          <CodeBlock
            language="bash"
            title="Output"
...
Clone complete: 8 succeeded, 0 failed`}
          ...
          <CodeBlock code={`gitmap-v23 clone text --verbose`} title="Terminal" />
        </div>
