    ...
    <DocsLayout>
      <div className="max-w-4xl">
        ...
        <section className="mb-10">
          ...
          <CodeBlock code="gitmap-v26 clone-next <v++|vN> [--delete] [--keep] [--no-desktop] [--create-remote] [--verbose]" />
        </section>
        ...
        <section className="mb-10">
          ...
          <TerminalPreview
            title="gitmap-v26 cn v15 --delete"
            lines={[
          ...
          <TerminalPreview
            title="gitmap-v26 cn v15 --create-remote --delete"
            lines={[
