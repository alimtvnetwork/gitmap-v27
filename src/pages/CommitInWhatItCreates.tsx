      ...
      <table className="w-full text-sm border border-border rounded-lg">
        ...
        <tbody>
          <tr className="border-t border-border">
            <td className="px-4 py-2 font-mono text-xs text-primary">gitmap-v23 cin ./new-repo https://github.com/me/old.git</td>
          ...
          <tr className="border-t border-border">
            <td className="px-4 py-2 font-mono text-xs text-primary">gitmap-v23 cin ./gitmap-v23 all</td>
            <td className="px-4 py-2 text-xs text-muted-foreground">Every <code>./gitmap-v23</code>, <code>-v2</code>, …, <code>-vN</code> sibling on disk is auto-discovered and replayed into <code>./gitmap-v23/</code> oldest&nbsp;→&nbsp;newest.</td>
          </tr>
          <tr className="border-t border-border">
            <td className="px-4 py-2 font-mono text-xs text-primary">gitmap-v23 cin ./gitmap-v23 -3</td>
            <td className="px-4 py-2 text-xs text-muted-foreground">Same as above, but only the latest 3 siblings (e.g. v17, v18, v19).</td>
          </tr>
          <tr className="border-t border-border">
            <td className="px-4 py-2 font-mono text-xs text-primary">gitmap-v23 cin ./canonical a,b,git@host:c.git</td>
