...
const TerminalPreview = () => (
  <div className="rounded-lg border border-border overflow-hidden my-6">
    <div className="bg-terminal px-4 py-2 flex items-center gap-2 border-b border-border">
      ...
      <span className="text-xs font-mono text-muted-foreground ml-2">gitmap-v23 diff-profiles default work</span>
    </div>
    ...
    <div className="max-w-4xl">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          ...
          <p className="text-muted-foreground font-mono text-sm">gitmap-v23 diff-profiles (dp)</p>
        </div>
      </div>
      ...
      <section className="mb-10">
        ...
        <CodeBlock code="gitmap-v23 diff-profiles <profileA> <profileB> [--all] [--json]" />
        <div className="mt-4">
