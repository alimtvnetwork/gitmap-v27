...
const CHECKS = [
  ...
  { name: "Active Binary", desc: "Locates gitmap-v23 on PATH and prints the resolved absolute path + version", severity: "info" },
...
const terminalLines = [
  { text: "gitmap-v23 doctor", type: "input" as const, delay: 800 },
  { text: "", type: "output" as const },
  { text: "  gitmap-v23 doctor v2.27.0", type: "header" as const },
  { text: "  ════════════════════════", type: "output" as const },
  { text: "", type: "output" as const },
  { text: "  ✓  Repo path          /home/user/repos", type: "accent" as const, delay: 200 },
  { text: "  ✓  Active binary      /usr/local/bin/gitmap-v23 (v2.27.0)", type: "accent" as const, delay: 150 },
  { text: "  ✓  Deployed binary    /opt/gitmap-v23/gitmap-v23", type: "accent" as const, delay: 150 },
...
const terminalFixLines = [
  { text: "gitmap-v23 doctor --fix-path", type: "input" as const, delay: 800 },
  { text: "", type: "output" as const },
  { text: "  Updating PATH to include gitmap-v23 binary location...", type: "output" as const, delay: 400 },
    ...
    <div className="max-w-4xl space-y-10">
      ...
      <div>
        ...
        <p className="text-lg text-muted-foreground">
          Diagnose your gitmap-v23 installation with 11 automated health checks.
        </p>
      </div>

      {/* Terminal Demo */}
      <section>
        <TerminalDemo title="gitmap-v23 doctor — all checks passing" lines={terminalLines} autoPlay />
      </section>
          ...
          <table className="w-full text-sm border border-border rounded-lg">
            ...
            <tbody>
              <tr className="border-t border-border">
                ...
                <td className="px-4 py-2 text-muted-foreground">Auto-fix PATH to include the gitmap-v23 binary directory</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section>
        ...
        <TerminalDemo title="gitmap-v23 doctor --fix-path" lines={terminalFixLines} autoPlay />
      </section>
...
gitmap-v23 doctor --fix-path`} />
      ...
      <section>
        ...
        <ul className="space-y-1 text-sm">
          {[
            { label: "gitmap-v23 setup", href: "/getting-started" },
            { label: "gitmap-v23 update", href: "/commands" },
