  ...
  return (
    <DocsLayout>
      ...
      <p className="text-muted-foreground mb-8">
        Get up and running with gitmap-v23 in under 5 minutes.
      </p>

      <section className="space-y-8">
        <div>
          <h2 className="text-xl font-heading font-semibold mb-3 docs-h2">1. Install gitmap-v23</h2>
          <p className="text-muted-foreground mb-3">
            Build from source using Go 1.21+:
          </p>
          <CodeBlock
            code={`go install github.com/alimtvnetwork/gitmap-v23/gitmap-v23@latest`}
            title="Terminal"
          />
          <p className="text-sm text-muted-foreground mt-2">
            Or clone the repo and build with the platform-appropriate script:
          </p>
          <CodeBlock code={`# Windows (PowerShell)\ngit clone https://github.com/alimtvnetwork/gitmap-v23/gitmap.git\ncd gitmap-v23\n./run.ps1`} title="PowerShell" language="powershell" />
        ...
        <div>
          ...
          <p className="text-muted-foreground mb-3">
            Point gitmap-v23 at a directory containing Git repositories:
          </p>
          <CodeBlock code={`gitmap-v23 scan ~/projects`} title="Terminal" />
          <p className="text-sm text-muted-foreground mt-2">
        ...
        <div>
          ...
          <CodeBlock
            code={`gitmap-v23 clone json --target-dir ./projects`}
            title="Terminal"
          />
          <p className="text-sm text-muted-foreground mt-2">
        ...
        <div>
          ...
          <p className="text-muted-foreground mb-3">
            Run <code className="docs-inline-code">gitmap-v23 setup</code> to auto-install the <code className="docs-inline-code">gcd</code> wrapper function. After restarting your terminal:
          </p>
          <CodeBlock
        ...
        <div>
          ...
          <CodeBlock code={`gitmap-v23 watch --interval 15`} title="Terminal" />
          <p className="text-sm text-muted-foreground mt-2">
