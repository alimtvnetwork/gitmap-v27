...
const GoModPage = () => {
  return (
    <DocsLayout>
      ...
      <CodeBlock
        code="gitmap-v23 gomod github.com/new/module"
        title="Rename module path in all files"
      />
      <CodeBlock
        code='gitmap-v23 gm github.com/new/module --ext "*.go,*.md"'
        title="Only replace in .go and .md files"
      />
      <CodeBlock
        code="gitmap-v23 gomod github.com/new/module --dry-run"
        title="Preview changes without modifying anything"
      />
      <CodeBlock
        code="gitmap-v23 gomod github.com/new/module --no-merge"
        title="Commit on feature branch but don't merge back"
      />
      <CodeBlock
        code="gitmap-v23 gomod github.com/new/module --no-tidy --verbose"
