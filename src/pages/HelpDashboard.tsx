...
const demoStaticLines = [
  { text: "gitmap-v23 help-dashboard", type: "input" as const, delay: 800 },
...
const demoDevLines = [
  { text: "gitmap-v23 hd", type: "input" as const, delay: 800 },
...
const demoPortLines = [
  { text: "gitmap-v23 hd --port 8080", type: "input" as const, delay: 800 },
...
const HelpDashboardPage = () => (
  <DocsLayout>
    ...
    <div className="rounded-lg border border-border bg-card p-4 mb-8 text-sm text-muted-foreground space-y-2">
      <p><strong className="text-foreground">1.</strong> Locates the <code className="text-primary">docs-site/</code> directory relative to the gitmap-v23 binary.</p>
    ...
    <CodeBlock code="gitmap-v23 help-dashboard [flags]" title="Basic usage" />
    <CodeBlock code="gitmap-v23 hd --port 8080" title="Custom port" />
