    ...
    <DocsLayout>
      <div className="mb-8">
        ...
        <p className="text-muted-foreground text-sm mt-2 max-w-3xl leading-relaxed">
          ...
          and served by{" "}
          <code className="docs-inline-code">gitmap-v26 help-dashboard</code> so
      ...
      <section>
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-3 max-w-3xl">
          ...
          gitmap-v26 binary. Run the dashboard to browse them offline:
        </p>
        <pre className="rounded-md bg-code-bg border border-border p-3 text-sm font-mono overflow-x-auto">
          <code>{`gitmap-v26 help-dashboard         # serves dist/ on http://localhost:5173
gitmap-v26 hd --port 8080         # custom port
