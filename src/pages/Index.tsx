        ...
        <div className="reveal">
          ...
          <div className="mx-auto mb-8 max-w-3xl rounded-xl bg-card/40 px-8 py-7 text-center backdrop-blur-sm">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-xs text-muted-foreground font-sans leading-relaxed">
              Uninstall removes the <code className="font-mono text-foreground">gitmap-v23</code> binary and its PATH entries, then prompts before deleting your data folder
              (<code className="font-mono text-foreground">%APPDATA%\gitmap-v23</code> on Windows, <code className="font-mono text-foreground">~/.config/gitmap-v23</code> on Linux/macOS).
