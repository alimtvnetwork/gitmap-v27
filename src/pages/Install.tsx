...
└── Get-LastRelease.ps1`} />
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border border-border rounded-lg overflow-hidden">
              ...
              <tbody className="divide-y divide-border">
                {[
                  ["install.ps1", "gitmap-v26/scripts/", "PowerShell one-liner installer for Windows"],
                  ["install.sh", "gitmap-v26/scripts/", "Bash one-liner installer for Linux/macOS"],
                  ["uninstall.ps1", "gitmap-v26/scripts/", "PowerShell uninstaller"],
                  ["Get-LastRelease.ps1", "gitmap-v26/scripts/", "Resolve latest release version (3-tier fallback)"],
  ...
  ✅ 6 scripts installed to /home/alim/Desktop/gitmap-scripts`} />
    ...
    Version: v2.65.0
    Binary: C:\\Users\\me\\AppData\\Local\\gitmap-v26\\gitmap.exe
    Install Dir: C:\\Users\\me\\AppData\\Local\\gitmap-v26
    ...
    Session PATH: refreshed for current PowerShell session`} />
            ...
            <div className="border border-border rounded-lg p-4 bg-card">
              ...
              <CodeBlock code={`Install summary
    Version: v2.65.0
    Binary: /Users/me/.local/bin/gitmap-v26
