...
const REPO_RAW = "https://raw.githubusercontent.com/alimtvnetwork/gitmap-v26/main";

const installCmds = {
  windows: `irm ${REPO_RAW}/gitmap-v26/scripts/install.ps1 | iex`,
  unix: `curl -fsSL ${REPO_RAW}/gitmap-v26/scripts/install.sh | sh`,
};
...
const installPinnedCmds = {
  windows: `$ver = 'v3.99.0'
$installer = irm ${REPO_RAW}/gitmap-v26/scripts/install.ps1
& ([scriptblock]::Create($installer)) -Version $ver -NoDiscovery`,
  unix: `curl -fsSL ${REPO_RAW}/gitmap-v26/scripts/install.sh \
    ...
    <DocsLayout>
      <div className="max-w-4xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-3xl font-heading font-bold docs-h1">Install &amp; Update gitmap-v26</h1>
        </div>
