...
const DryRunPreview = () => (
  <div className="rounded-lg border border-border overflow-hidden my-6">
    <div className="bg-terminal px-4 py-2 flex items-center gap-2 border-b border-border">
      ...
      <span className="text-xs font-mono text-muted-foreground ml-2">gitmap-v23 prune --dry-run</span>
    </div>
...
const DeletePreview = () => (
  <div className="rounded-lg border border-border overflow-hidden my-6">
    <div className="bg-terminal px-4 py-2 flex items-center gap-2 border-b border-border">
      ...
      <span className="text-xs font-mono text-muted-foreground ml-2">gitmap-v23 prune --confirm</span>
    </div>
    <div className="bg-terminal p-4 font-mono text-sm leading-relaxed overflow-x-auto text-xs">
...
gitmap-v23 prune --dry-run

# Delete without prompting
gitmap-v23 prune --confirm

# Delete locally and remotely
gitmap-v23 prune --confirm --remote`} />
      </section>
