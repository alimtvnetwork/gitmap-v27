...
const ReleasePage = () => {
    ...
    <DocsLayout>
      <div className="space-y-10">
        ...
        <div>
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg border border-border bg-card">
              <h3 className="font-mono font-semibold text-foreground mb-1">gitmap-v23 release [version] <span className="text-muted-foreground font-normal text-sm">(alias: r)</span></h3>
            ...
            <div className="p-4 rounded-lg border border-border bg-card">
              <h3 className="font-mono font-semibold text-foreground mb-1">gitmap-v23 release-branch &lt;branch&gt; <span className="text-muted-foreground font-normal text-sm">(alias: rb)</span></h3>
              <p className="text-sm text-muted-foreground">Complete a release from an existing release/vX.Y.Z branch.</p>
            </div>
            <div className="p-4 rounded-lg border border-border bg-card">
              <h3 className="font-mono font-semibold text-foreground mb-1">gitmap-v23 release-pending <span className="text-muted-foreground font-normal text-sm">(alias: rp)</span></h3>
        ...
        <div>
          ...
          <h3 className="text-base font-heading font-semibold text-foreground mb-3">gitmap-v23 release [version]</h3>
          ...
          <h3 className="text-base font-heading font-semibold text-foreground mb-3">gitmap-v23 release-branch / release-pending</h3>
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mb-4">
            When a <code className="font-mono text-primary">go.mod</code> file is detected, gitmap-v23 automatically
          ...
          <p className="text-sm text-muted-foreground mt-4">
            Use <code className="font-mono text-primary">gitmap-v23 release --list-targets</code> to inspect
            the resolved matrix:
          </p>
          <CodeBlock code={`$ gitmap-v23 release --list-targets\nRelease targets (6):\nSource: built-in defaults\n\n  windows/amd64\n  windows/arm64\n  linux/amd64\n  linux/arm64\n  darwin/amd64\n  darwin/arm64`} />

          <p className="text-sm text-muted-foreground mt-4">
            With a <code className="font-mono text-primary">--targets</code> override:
          </p>
          <CodeBlock code={`$ gitmap-v23 release --list-targets --targets windows/amd64,linux/amd64\nRelease targets (2):\nSource: --targets flag\n\n  windows/amd64\n  linux/amd64`} />
        </div>
        ...
        <div>
          ...
          <div className="space-y-2 mb-6">
            {[
              { label: "CLI argument", example: "gitmap-v23 release v1.2.3" },
        ...
        <div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <CodeBlock code="gitmap-v23 release v1.2.3" />
            </div>
            <div>
              <p className="text-sm text-muted-foreground mb-2">Auto-increment with compression and checksums</p>
              <CodeBlock code="gitmap-v23 release --bump patch --compress --checksums" />
            </div>
            <div>
              <p className="text-sm text-muted-foreground mb-2">Custom cross-compile targets</p>
              <CodeBlock code="gitmap-v23 release v2.0.0 --targets windows/amd64,linux/amd64" />
            </div>
            <div>
        ...
        <div>
          ...
          <div className="bg-card border border-border rounded-lg p-5 font-mono text-sm space-y-1">
            <p className="text-muted-foreground">{`$ gitmap-v23 release v1.2.3 --dry-run`}</p>
        ...
        <div>
          ...
          <div className="bg-card border border-border rounded-lg p-5 font-mono text-sm space-y-1 mb-6">
            <p className="text-muted-foreground">$ gitmap-v23 release --bump patch</p>
  ...
  "assets": [
    ...
    "docs-bundle_v3.0.0.zip"
          ...
          <div className="bg-card border border-border rounded-lg p-5 font-mono text-sm space-y-1">
            <p className="text-muted-foreground">$ gitmap-v23 release v3.0.0 --zip-group docs-bundle -Z ./report.pdf --dry-run</p>
