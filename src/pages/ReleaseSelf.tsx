...
const features = [
  { icon: Tag, title: "Self-Release", desc: "Release gitmap-v23 itself from any directory" },
...
const selfReleaseDemo = {
  title: "gitmap-v23 release-self --bump patch",
  lines: [
    { text: "$ gitmap-v23 rs --bump patch", type: "input" as const, delay: 0 },
    { text: "→ Self-release: switching to /home/user/go/src/gitmap-v23", type: "accent" as const, delay: 600 },
...
const autoFallbackDemo = {
  ...
  lines: [
    ...
    { text: "$ gitmap-v23 release --bump minor", type: "input" as const, delay: 600 },
    { text: "→ Self-release: switching to /home/user/go/src/gitmap-v23", type: "accent" as const, delay: 600 },
...
const errorScenarios = [
  { scenario: "Executable path + DB fallback both fail", behavior: "Exit 1: could not locate gitmap-v23 source repository" },
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-lg">
            Release gitmap-v23 itself from any directory — explicitly or via auto-fallback.
          </p>
        </div>
        ...
        <section>
          ...
          <CodeBlock code="gitmap-v23 release-self [version] [flags]" />
        ...
        <section>
          ...
          <div className="space-y-3">
            {[
              ...
              { step: "4", title: "Execute release", desc: "Runs the full release workflow (identical to gitmap-v23 release) from the source repo." },
        ...
        <section>
          ...
          <div className="space-y-4">
            <div>
              ...
              <CodeBlock code="gitmap-v23 rs --bump minor --dry-run" />
            </div>
            <div>
              <p className="text-sm text-muted-foreground mb-1">Self-release with assets and compression</p>
              <CodeBlock code="gitmap-v23 rs v2.46.0 --assets ./dist --compress --checksums" />
            </div>
            <div>
              <p className="text-sm text-muted-foreground mb-1">Draft self-release</p>
              <CodeBlock code="gitmap-v23 rs --bump patch --draft --notes 'pre-release test'" />
            </div>
          </div>
        </section>
