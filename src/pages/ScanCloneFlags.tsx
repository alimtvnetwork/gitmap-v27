  ...
  return (
    <DocsLayout>
      ...
      <p className="text-muted-foreground mb-6">
        Every supported flag for <code className="font-mono text-primary">gitmap-v26 scan</code> and{" "}
        <code className="font-mono text-primary">gitmap-v26 clone</code>, with defaults and valid values.
        {" "}
