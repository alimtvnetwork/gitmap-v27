...
const setupDemo = [
  { text: "gitmap-v23 setup", type: "input" as const, delay: 800 },
...
const dryRunDemo = [
  { text: "gitmap-v23 setup --dry-run", type: "input" as const, delay: 800 },
  { text: "", type: "output" as const },
...
const helpText = `# gitmap-v23 setup
...
- config — View/edit gitmap-v23 configuration`;

const bashWrapper = `# Installed by gitmap-v23 setup into ~/.bashrc
gcd() {
  local dest
  dest="$(gitmap-v23 cd "$@")"
...
const zshWrapper = `# Installed by gitmap-v23 setup into ~/.zshrc
gcd() {
  local dest
  dest="$(gitmap-v23 cd "$@")"
  if [[ -n "$dest" ]] && [[ -d "$dest" ]]; then
...
const powershellWrapper = `# Installed by gitmap-v23 setup into $PROFILE
function gcd {
  $dest = gitmap-v23 cd @args
...
const features = [
  ...
  },
  {
    ...
    desc: "Auto-installs shell completions for all gitmap-v23 commands, repos, groups, and aliases",
  },
  {
    icon: CheckCircle,
    title: "Idempotent",
    ...
    <DocsLayout>
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-muted-foreground mb-8 font-body">
          ...
          and enable shell tab-completions for every gitmap-v23 command.
        </p>

        {/* Terminal Preview */}
        <section className="mb-12">
          <h2 className="docs-h2">First-Time Setup</h2>
          <TerminalDemo lines={setupDemo} title="gitmap-v23 setup" />
        </section>
        ...
        <section className="mb-12">
          ...
          <CodeBlock code={helpText} language="markdown" title="gitmap-v23 setup --help" />
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4 font-body">
            ...
            <code className="docs-inline-code">gitmap-v23 cd</code> and performs the actual directory change.
          ...
          <div className="mt-4 p-3 rounded-lg border border-border bg-muted/30">
            <p className="text-sm text-muted-foreground font-body">
              ...
              <code className="docs-inline-code"># gitmap-v23 cd wrapper</code> comment. Setup checks for this
        ...
        <section className="mb-12">
          ...
          <TerminalDemo lines={dryRunDemo} title="gitmap-v23 setup --dry-run" />
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-2 text-muted-foreground font-body">
            ...
            <li>
              ...
              — View and edit gitmap-v23 configuration
            </li>
            <li>
