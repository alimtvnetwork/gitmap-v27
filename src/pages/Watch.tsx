    ...
    <div className="rounded-lg border border-border overflow-hidden my-6">
      ...
      <div className="bg-terminal p-4 font-mono text-sm leading-relaxed overflow-x-auto">
        ...
        <div className="text-primary">
          <div>╔══════════════════════════════════════╗</div>
          <div>║          gitmap-v26 watch{"                "}║</div>
          <div>╚══════════════════════════════════════╝</div>
        </div>

        <div className="text-muted-foreground mt-2 text-xs">
          gitmap-v26 watch — refreshing every 30s (Ctrl+C to stop)
        </div>
...
const WatchPage = () => {
  return (
    <DocsLayout>
      ...
      <CodeBlock code="gitmap-v26 watch" title="Basic — refresh every 30s" />
      <CodeBlock
        code="gitmap-v26 watch --interval 10"
        title="Custom refresh interval"
      />
      <CodeBlock
        code="gitmap-v26 watch --group work"
        title="Filter by group"
      />
      <CodeBlock
        code="gitmap-v26 watch --no-fetch"
        title="Skip git fetch (local refs only)"
      />
      <CodeBlock
        code="gitmap-v26 watch --json"
