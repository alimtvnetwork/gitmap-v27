...
const TerminalPreview = () => (
  <div className="rounded-lg border border-border overflow-hidden my-6">
    <div className="bg-terminal px-4 py-2 flex items-center gap-2 border-b border-border">
      ...
      <span className="text-xs font-mono text-muted-foreground ml-2">gitmap-v23 zip-group list</span>
    </div>
...
const ShowPreview = () => (
  <div className="rounded-lg border border-border overflow-hidden my-6">
    <div className="bg-terminal px-4 py-2 flex items-center gap-2 border-b border-border">
      ...
      <span className="text-xs font-mono text-muted-foreground ml-2">gitmap-v23 z show "chrome extension"</span>
    </div>
    <div className="bg-terminal p-4 font-mono text-sm leading-relaxed overflow-x-auto">
  ...
  <DocsLayout>
    ...
    <div className="rounded-lg border border-border bg-card p-4 mb-8">
      <p className="text-sm text-muted-foreground mb-3">
        When you provide a path, gitmap-v23 resolves it into three components:
      </p>
    ...
    <CodeBlock code={`gitmap-v23 z create "chrome extension" chrome-extension/dist`} title="Create group with path (one step)" />
    <CodeBlock code="gitmap-v23 z create docs-bundle" title="Create empty group" />
    <CodeBlock code="gitmap-v23 z add docs-bundle ./README.md ./CHANGELOG.md ./docs/" title="Add items to a group" />
    <CodeBlock code="gitmap-v23 z create extras --archive extra-files.zip" title="Create with custom archive name" />
    <CodeBlock code={`gitmap-v23 z show "chrome extension"`} title="Show group contents (folders expanded)" />
    <CodeBlock code="gitmap-v23 z list" title="List all zip groups" />
    <CodeBlock code="gitmap-v23 z rename docs-bundle --archive release-docs.zip" title="Set custom archive name" />
    <CodeBlock code="gitmap-v23 z remove docs-bundle ./CHANGELOG.md" title="Remove an item from a group" />
    <CodeBlock code="gitmap-v23 z delete extras" title="Delete a zip group" />
    ...
    <CodeBlock code="gitmap-v23 release v3.0.0 --zip-group docs-bundle" title="Release with a persistent zip group" />
    <CodeBlock code="gitmap-v23 release v3.0.0 -Z ./dist/report.pdf -Z ./dist/manual.pdf --bundle docs.zip" title="Ad-hoc bundle" />
    <CodeBlock code="gitmap-v23 release v3.0.0 --zip-group docs-bundle -Z ./extras/notes.txt" title="Combined: group + ad-hoc" />
